...
<div class="container">
    ...
    <table class="table">
        ...
        foreach($notYet as $ok){
            ...
            echo "<td><button type='button' class='btn btn-default btn-lg center-block' onclick='delete(".$ok[3].")'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></button></td>";
            echo "</tr>";
        }
        ?>
    </table>
